...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='正确提交';
...
INSERT INTO `accepted` VALUES (16,1,1,'php','2017-02-28 03:16:00','2017-03-10 06:41:01'),(18,1,1,'java','2017-03-10 06:48:31','2017-03-14 10:21:04'),(19,1,2,'java','2017-03-14 02:36:56','2017-03-14 02:36:56'),(20,1,3,'java','2017-03-16 03:05:02','2017-03-16 03:09:22');
...
INSERT INTO `questions` VALUES (1,1,'两数之和',1,'two-sum',1),(2,3,'链表的交点',2,'linked-list-intersection',1),(3,6,'子数组的最大乘积',5,'max-product-of-sub-array',0),(4,2,'共有多少条路径',3,'how-many-path',1);
...
CREATE TABLE `solution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid` (`uid`,`qno`,`lang`)
) ENGINE=InnoDB AUTO_INCREMENT=450 DEFAULT CHARSET=utf8mb4 COMMENT='用户提交代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-20 10:40:41

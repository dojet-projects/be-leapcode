...
INSERT INTO `accepted` VALUES (16,1,1,'php','2017-02-28 03:16:00','2017-03-10 06:41:01'),(17,1,4,'php','2017-02-28 03:17:19','2017-03-08 05:36:27'),(18,1,1,'java','2017-03-10 06:48:31','2017-03-13 22:28:14'),(19,1,2,'java','2017-03-14 02:36:56','2017-03-14 02:36:56');
...
INSERT INTO `questions` VALUES (1,1,'两数之和',1,'two-sum',1),(2,5,'链表的交点',3,'linked-list-intersection',0),(3,6,'子数组的最大乘积',5,'max-product-of-sub-array',0),(4,2,'共有多少条路径',4,'how-many-path',1);
...
CREATE TABLE `solution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid` (`uid`,`qno`,`lang`)
) ENGINE=InnoDB AUTO_INCREMENT=411 DEFAULT CHARSET=utf8mb4 COMMENT='用户提交代码';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-14 10:43:55

...
INSERT INTO `accepted` VALUES (16,1,1,'php','2017-02-28 03:16:00','2017-03-22 07:52:21'),(18,1,1,'java','2017-03-10 06:48:31','2017-03-22 07:52:14'),(19,1,2,'java','2017-03-14 02:36:56','2017-03-21 06:02:10'),(20,1,3,'java','2017-03-16 03:05:02','2017-03-23 08:40:32');
...
CREATE TABLE `questions` (
  ...
  UNIQUE KEY `qno` (`qno`),
  KEY `pub` (`pub`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='问题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `questions` VALUES (1,1,'两数之和',1,'two-sum',1),(2,3,'链表的交点',2,'linked-list-intersection',1),(3,6,'子数组的最大乘积',5,'max-product-of-sub-array',0),(4,2,'共有多少条路径',3,'how-many-path',1),(5,4,'股票交易的最大收益',2,'max-transaction-profit',1),(6,5,'质数判断',1,'prime-number',1);
...
CREATE TABLE `solution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uid` (`uid`,`qno`,`lang`)
) ENGINE=InnoDB AUTO_INCREMENT=516 DEFAULT CHARSET=utf8mb4 COMMENT='用户提交代码';
/*!40101 SET character_set_client = @saved_cs_client */;

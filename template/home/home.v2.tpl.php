...
<?php else : ?>
          <div class="row">
            <form class="form signup-form" method="POST" action="/invite/commit">
              <div class="col-md-5 no-padding-left-md">
                <div class="form-group"><input autofocus="autofocus" maxlength="32" minlength="32" name="invitecode" placeholder="邀请码" type="text" required="" class="form-control input-lg"></div>
              </div>
